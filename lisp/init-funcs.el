...
(defun danny--load-theme (theme)
  ...
  (when-let ((theme (danny--theme-name theme)))
...
(defun danny--load-system-theme (appearance)
  ...
  (mapc #'disable-theme custom-enabled-themes)
  (danny--load-theme (alist-get appearance danny-system-themes)))
  ...
  (pcase danny-theme
    ...
    ('system
     ...
     (use-package auto-dark
       :init
       (setq auto-dark-light-theme (alist-get 'light danny-system-themes)
             auto-dark-dark-theme (alist-get 'dark danny-system-themes))
       (auto-dark-mode 1)
